	...
	var a = k[m.k] = {
		...
		f : function() {
			return {
				...
				pin : function(b) {
					var c = a.a.pin + "?", d = "false", e = a.f.get(b, "pinImg"), g = a.f.get(b, "pinUrl") || a.d.URL, f = a.v.selectedText || a.f.get(b, "pinDesc") || a.d.title;
					g = g.split("#")[0];
					if (b.rel === "video")
						d = "true";
				...
				call : function(b, c) {
					var d = a.f.callback.length, e = a.a.k + ".f.callback[" + d + "]", g = a.d.createElement("SCRIPT");
					...
					checkDomain : function(b) {
						...
						if (b && b.disallowed_domains && b.disallowed_domains.length) {
							...
							for ( d = a.v.thumbed.length; c < d; c += 1)
								a.v.badDomain[a.f.get(a.v.thumbed[c], "domain")] === true && a.f.unThumb(a.v.thumbed[c].id.split("thumb_").pop())
						}
					},
					info : function(b) {
						if (b)
					...
					if (j.pUrl && j.pImg) {
						...
						if (c.fixImg)
							if (j.pImg.match(c.fixImg.find))
								j.pImg = j.pImg.replace(c.fixImg.find, c.fixImg.replace);
				...
				hazTag : {
					img : function(b) {
						if (a.v.inlineHandler && typeof a.f.handleInline[a.v.inlineHandler] === "function")
							...
							if (b.height > a.a.minImgSize && b.width > a.a.minImgSize) {
								if (b.parentNode.tagName === "A" && b.parentNode.href) {
									var c = b.parentNode, d = c.href.split(".").pop().split("?")[0].split("#")[0];
